...
## Project Structure
    ...
    ├── testapiautosetting_127222  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127222`
...
2. Clone this repo and `cd testapiautosetting_127222`
